...
import hashlib
def compare_hashes(pwd):
    pwd = hashlib.sha256(str.encode(pwd)).hexdigest()
    if pwd == "6b0b923f01e3044e830af9044594d5554a4f7724c25e3754c0d993a7ccaa3808":
        return True
    else:
        return False

password = st.text_input('Password',type='password')
result = compare_hashes(password)
if result == True:
    print("result true")
    mainprogram()
else:
